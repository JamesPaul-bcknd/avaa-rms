      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-10 animate-in fade-in duration-300">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm">
              ...
              <div className="flex justify-end gap-3 mt-8">
                <button onClick={() => router.push('/hr-dashboard')} className="px-6 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-lg text-[13px] font-bold hover:bg-slate-50 transition-colors shadow-sm">Discard</button>
                <button onClick={() => router.push('/hr-dashboard')} className="px-6 py-2.5 bg-[#7EB0AB] hover:bg-[#689b96] text-white rounded-lg text-[13px] font-bold transition-colors shadow-sm active:scale-95">Save Changes</button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm">
              <div className="mb-6">
                ...
                <p className="text-[13px] text-slate-500 mt-1">Edit your company name, email, and other essential information.</p>
              </div>
        ...
        {activeTab === 'security' && (
          <div className="space-y-8">
            ...
            {/* Top Info section */}
            <div>
              <h2 className="text-[20px] font-bold text-slate-800">Security Settings</h2>
              <p className="text-[13px] text-slate-500 mt-1">Manage your alerts and password to keep your account secure.</p>
            </div>
