      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-6">
          <div className="relative">
            ...
            <input type="text" placeholder="Search users..." className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-sm w-64 outline-none focus:ring-2 focus:ring-teal-500/20" />
          </div>
          {/* ... Other Header Items ... */}
        </div>
      </div>
