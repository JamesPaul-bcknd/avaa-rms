        ...
        <div className="flex min-h-screen page-enter">
            ...
            <div className="flex-1 flex flex-col px-6 sm:px-12 lg:px-16 bg-white overflow-y-auto overflow-x-hidden min-h-screen">
                <div className="flex-1 flex items-center justify-center w-full min-h-max py-8 relative">
                    <div className="w-full max-w-[480px]">
                        ...
                        <form onSubmit={handleSignIn} className="space-y-6">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <Link href="/user/forgot-password" className="text-sm font-medium text-[#7EB0AB] hover:text-[#6A9994] transition-colors">
                                        Forgot password?
                                    </Link>
                                </div>
                                <div className="relative">
                                    ...
                                    <input id="login-password" type={loginShowPassword ? 'text' : 'password'} placeholder="••••••••"
                        ...
                        <p className="text-center text-[15px] text-[#6b7280] mt-6">
                            ...
                            <a href="/signup" className="font-semibold text-[#7EB0AB] hover:text-[#6A9994] transition-colors">
                                Sign up
                            </a>
                        </p>
                    </div>
                ...
                <div className="w-full pb-8 pt-4 shrink-0 mt-auto">
                    <p className="text-center text-[12px] text-[#9ca3af] leading-snug">
